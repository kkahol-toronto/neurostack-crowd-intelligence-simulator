...
class Config:
    ...
    # Flask configuration
    SECRET_KEY = os.environ.get('SECRET_KEY', 'neurostack-cis-dev-secret')
    DEBUG = os.environ.get('FLASK_DEBUG', 'True').lower() == 'true'
    
    # JSON configuration - disable ASCII escaping and allow Chinese to be displayed directly (instead of \uXXXX format)
    JSON_AS_ASCII = False
    ...
    #Available action configurations on the OASIS platform
