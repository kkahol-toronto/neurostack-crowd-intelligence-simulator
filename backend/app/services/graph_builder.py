...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        graph_name: str = "NeuroStack Crowd Intelligence Simulator Graph",
        chunk_size: int = 500,
    ...
    def create_graph(self, name: str) -> str:
        ...
        graph_id = f"neurostack_{uuid.uuid4().hex[:16]}"
        
        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="NeuroStack Crowd Intelligence Simulator — social simulation graph",
        )
