...
logger = get_logger('neurostack_cis.simulation')
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if progress_callback:
                progress_callback(
                    "reading", 100, 
                    f"Completed with {filtered.filtered_count} entities",
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. Activate the conda environment: conda activate neurostack_cis\n"
