...
logger = get_logger('neurostack_cis.retry')
...
class RetryableAPIClient:
    ...
    def call_with_retry(
        ...
        **kwargs
        ...
        """
        Run a function call with retries on failure
    ...
    def call_batch_with_retry(
        ...
        """
        Batch calls with per-item retry

        Args:
            items: Items to process
            process_func: Processor taking a single item
            exceptions: Exception types to retry on
