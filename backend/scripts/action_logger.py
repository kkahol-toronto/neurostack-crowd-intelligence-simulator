"""
Action logging for OASIS simulations (per-agent actions for backend monitoring).
...
class PlatformActionLogger:
    """JSONL logger for one platform."""
    
    def __init__(self, platform: str, base_dir: str):
        """
        Args:
            platform: Platform name (twitter/reddit)
            base_dir: Simulation directory root
        """
...
class SimulationLogManager:
    """
    Coordinates main simulation.log and per-platform JSONL loggers.
    """
    ...
    def _setup_main_logger(self):
        """Configure simulation.log and console."""
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Return Twitter PlatformActionLogger."""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Return Reddit PlatformActionLogger."""
...
class ActionLogger:
    """
    Legacy combined-path action logger.
