    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM reads your documents and requirement, extracts seeds, and proposes an ontology.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Chunks are ingested into Zep to build the graph, entities/relations, temporal memory, and summaries.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph build finished — continue to environment setup.</p>
          <button 
            class="action-btn" 
...
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('Missing project or graph')
    return
  }
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      console.error('createSimulation failed:', res.error)
