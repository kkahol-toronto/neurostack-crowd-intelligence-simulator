        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Lightweight chat with the report agent: four tools and full simulator memory.</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-backed lookup for fast node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Parallel multi-turn interviews with agents for open-ended views and sentiment.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent about the report.' : 'Chat with agents to hear their views.' }}
              </p>
            </div>
            <div 
...
const chatHistoryCache = ref({}) // Per-target history: report_agent, agent_0, ...
...
const renderMarkdown = (content) => {
  ...
  // Trim <br> between block end and next <p>
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Continue ol numbering across split lists
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prefer reddit payload, else twitter
...
/* Left panel — match Step4 report layout */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
